...
class MainViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        showViewController(viewController: UINavigationController.self, storyboardId: "MovieNavID", storyboardName: "MovieViewController")
    }
...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 0:
            // Movies
            self.showViewController(viewController: UINavigationController.self, storyboardId: "MovieNavID", storyboardName: "MovieViewController")
        case 1:
            // tickets
            self.showViewController(viewController: UINavigationController.self, storyboardId: "TicketNavID", storyboardName: "TicketsViewController")
            break
        case 2:
            // signin
            self.showViewController(viewController: UINavigationController.self, storyboardId: "PageController", storyboardName: "PageViewController")
            break
        case 3:
            
            // settings
            self.showViewController(viewController: UINavigationController.self, storyboardId: "SettingsNavID", storyboardName: "SettingsViewController")
            break
